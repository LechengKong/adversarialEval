...
def createModel():
    model = keras.Sequential([
        ...
        keras.layers.Dense(10, activation=tf.nn.softmax,kernel_regularizer=regularizers.l2(0.00001))
    ])
...
checkpoint_path = "training_reg_000001/cp.ckpt"
