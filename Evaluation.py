...
adv_examples_10=np.load('regpack/FC(10^-1).npy')
adv_examples_20=np.load('regpack/FC(10^-2).npy')
adv_examples_40=np.load('regpack/FC(10^-4).npy')
adv_examples_50=np.load('sigmoidpack/FC(1x1x1x-7).npy')
adv_examples_60=np.load('sigmoidpack/FC(2x2x1x-7).npy')
train_labelsoft=np.load('softmax10.npy')
...
model=createModel(1.1)
model.load_weights(checkpoint_path)

prediction_adv10=model.predict(adv_examples_10)
prediction_adv20=model.predict(adv_examples_20)
prediction_adv40=model.predict(adv_examples_40)
prediction_adv50=model.predict(adv_examples_50)
prediction_adv60=model.predict(adv_examples_60)


Adv10=One_hot(prediction_adv10)
Adv20=One_hot(prediction_adv20)
Adv40=One_hot(prediction_adv40)
Adv50=One_hot(prediction_adv50)
Adv60=One_hot(prediction_adv60)


E10=Test_acc(Adv10,test_labels)
E20=Test_acc(Adv20,test_labels)
E40=Test_acc(Adv40,test_labels)
E50=Test_acc(Adv50,test_labels)
E60=Test_acc(Adv60,test_labels)

print('The ADv10 error is:',E10)
print('The ADv20 error is:',E20)
print('The ADv40 error is:',E40)
print('The ADv50 error is:',E50)
print('The ADv60 error is:',E60)
